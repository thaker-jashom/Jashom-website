...
export function HealthTechPage() {
    return (
        <DetailLayout
            title="HealthTech"
            description="Jashom develops AI-powered healthcare platforms that automate workflows, enhance patient care, and maintain regulatory compliance—ensuring speed, precision, and safety."
            whatWeOffer={[
